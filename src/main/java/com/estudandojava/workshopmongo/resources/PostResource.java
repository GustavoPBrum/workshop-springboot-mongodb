...
import com.estudandojava.workshopmongo.resources.util.URL;
import com.estudandojava.workshopmongo.services.PostService;

@RestController
@RequestMapping(value ="/posts")  // Nome do caminho geralmente posto no plural
public class PostResource {
	...
	@GetMapping(value = "/fullsearch")  // Se o 'text' nao for informado, sera inserido uma String vazia
